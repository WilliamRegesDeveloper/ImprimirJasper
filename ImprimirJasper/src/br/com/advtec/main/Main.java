...
* classe integrada a um ERP onde o mesmo envia parametros para 
  ...
  de entrada para os crit√©rios de uma query
*/
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/**
			 * Busca o relat√≥rio na pasta, associa um map de parametros e conecta ao banco de dados para lan√ßar a query
			 **/
			...
			/**abre arquivo gerado direto em alguma aplicaÁ„o padr„o que suporte extens„o .pdf*/
